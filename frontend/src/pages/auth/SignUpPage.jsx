...
const SignUpPage = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    loginMutation({ fullname, email, password });
  };
  ...
  return (
    <div className="flex flex-col items-center py-8">
      <p className="text-3xl text-center mb-8">Sign Up Here</p>
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="btn text-secondary font-semibold text-xl btn-accent"
        >
          Sign Up
        </button>
      </form>
